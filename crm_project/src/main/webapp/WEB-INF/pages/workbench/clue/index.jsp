    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#saveCreateClueBtn").click(function () {
                ...
                // 发送请求
                $.ajax({
                    url: 'workbench/clue/saveCreatedClue.do',
                    data: {
                        fullname: fullname,
            ...
            $("#deleteClueBtn").click(function () {
                ...
                if (window.confirm("삭제하시겠습니까?")) { // 判断是否确认删除
            ...
            $("#saveEditClueBtn").click(function () {
                ...
                // 发送请求
                $.ajax({
                    url: 'workbench/clue/saveEditedClue.do',
                    data: {
                        id: id,
                        fullname: fullname,
                        appellation: appellation,
        ...
        function queryClueByConditionForPage(pageNo, pageSize) {
            ...
            var source = $("#query-source option:selected").val(); // 获取下拉框选中的线索来源
            var owner = $("#query-owner").val();
            var mphone = $("#query-mphone").val();
            var state = $("#query-state option:selected").val(); // 获取下拉框选中的线索状态
            // 前端向后端发送请求
            $.ajax({
    ...
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">리드 등록</h4>
            </div>
            <div class="modal-body">
                <form id="createClueForm" class="form-horizontal" role="form">

                    <div class="form-group">
                        <label for="create-owner" class="col-sm-2 control-label">소유자</label>
                        ...
                        <label for="create-company" class="col-sm-2 control-label">회사</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="create-appellation" class="col-sm-2 control-label">호칭</label>
                        <div class="col-sm-10" style="width: 300px;">
                        ...
                        <label for="create-fullname" class="col-sm-2 control-label">성명</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="create-job" class="col-sm-2 control-label">직책</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-job">
                        </div>
                        <label for="create-email" class="col-sm-2 control-label">이메일</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="create-phone" class="col-sm-2 control-label">회사 전화번호</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-phone">
                        </div>
                        <label for="create-website" class="col-sm-2 control-label">회사 홈페이지</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="create-mphone" class="col-sm-2 control-label">휴대폰</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-mphone">
                        </div>
                        <label for="create-state" class="col-sm-2 control-label">리드 상태</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="create-source" class="col-sm-2 control-label">출처</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="create-description" class="col-sm-2 control-label">리드 상세</label>
                    ...
                    <div style="position: relative;top: 15px;">
                        <div class="form-group">
                            <label for="create-contactSummary" class="col-sm-2 control-label">연락 메모</label>
                            <div class="col-sm-10" style="width: 81%;">
                                <textarea class="form-control" rows="3" id="create-contactSummary"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="create-nextContactTime" class="col-sm-2 control-label">다음 연락 시간</label>
                            <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div style="position: relative;top: 20px;">
                        <div class="form-group">
                            <label for="create-address" class="col-sm-2 control-label">상세 주소</label>
                            <div class="col-sm-10" style="width: 81%;">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="saveCreateClueBtn">저장</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="edit-owner" class="col-sm-2 control-label">소유자</label>
                        <div class="col-sm-10" style="width: 300px;">
                        ...
                        <label for="edit-company" class="col-sm-2 control-label">회사</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="edit-appellation" class="col-sm-2 control-label">호칭</label>
                        <div class="col-sm-10" style="width: 300px;">
                        ...
                        <label for="edit-fullname" class="col-sm-2 control-label">성명<span
                    ...
                    <div class="form-group">
                        <label for="edit-job" class="col-sm-2 control-label">직책</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-job" value="CTO">
                        </div>
                        <label for="edit-email" class="col-sm-2 control-label">이메일</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="edit-phone" class="col-sm-2 control-label">회사 전회번호</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-phone" value="010-84846003">
                        </div>
                        <label for="edit-website" class="col-sm-2 control-label">회사 홈페이지</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        ...
                        <label for="edit-state" class="col-sm-2 control-label">리드 상태</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="edit-source" class="col-sm-2 control-label">출처</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        <label for="edit-description" class="col-sm-2 control-label">리드 상세</label>
                        <div class="col-sm-10" style="width: 81%;">
                    ...
                    <div style="position: relative;top: 15px;">
                        <div class="form-group">
                            <label for="edit-contactSummary" class="col-sm-2 control-label">연락 메모</label>
                            <div class="col-sm-10" style="width: 81%;">
                                <textarea class="form-control" rows="3"
                        ...
                        <div class="form-group">
                            <label for="edit-nextContactTime" class="col-sm-2 control-label">다음 연락 시간</label>
                            <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div style="position: relative;top: 20px;">
                        <div class="form-group">
                            <label for="edit-address" class="col-sm-2 control-label">상세 주소</label>
                            <div class="col-sm-10" style="width: 81%;">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">닫기</button>
                <button type="button" class="btn btn-primary" id="saveEditClueBtn">수정</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar" style="height: 80px;">
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">회사</div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">회사 전화번호</div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">출처</div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">휴대폰 번호</div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">리드 상태</div>
                ...
                <button type="button" class="btn btn-default" id="queryClueBtn">조회</button>
                &nbsp;
                <button type="button" class="btn btn-default" id="clearClueBtn">초기화</button>
            </form>
        </div>
